...
const Products = ({ val, setval, list }) => {
          ...
          <div className="grid grid-cols-1 gap-2">
            {filteredProduct.map((item, idx) => (
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className="bg-gradient-to-r from-green-600/80 to-green-500/80 rounded-lg p-3 cursor-pointer shadow-md"
              ...
              >
                <div className="flex justify-between items-center flex-wrap">
                  <div className="flex items-center min-w-0 mr-2">
                    ...
                    <h3 className="text-white font-medium truncate">{item.product}</h3>
                  </div>
                  <div className="bg-green-800/50 px-3 py-1 rounded-full flex-shrink-0">
                    <p className="text-white font-semibold">₹{item.price_per_kg}</p>
